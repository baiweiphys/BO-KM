...
save('saveData_BernsteinModes_deg90_BK100.mat','pas','wws');
...
print(gcf,'-depsc',['saveData_BernsteinModes_deg90_BK100_','select.eps']);
savefig(['saveData_BernsteinModes_deg90_BK100_','select.fig']);
