...
save('saveData_BernsteinModes_ion_deg90_BK2.mat','pas','wws');
...
print(gcf,'-depsc',['saveData_BernsteinModes_ion_deg90_BK2_','select.eps']);
savefig(['saveData_BernsteinModes_ion_deg90_BK2_','select.fig']);
