...
save('saveData_benchmark_EMIC_KUPDAP_th30.mat','pas','wws');
...
print(gcf,'-depsc',['saveData_benchmark_EMIC_KUPDAP_th30_','select.eps']);
savefig(['saveData_benchmark_EMIC_KUPDAP_th30_','select.fig']);
