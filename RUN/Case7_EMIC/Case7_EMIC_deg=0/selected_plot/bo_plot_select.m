...
save('Case_EMIC_th=0_B0=100nT_Tsz=1879.mat','pas','wws');
...
print(gcf,'-depsc',['Case_EMIC_th=0_B0=100nT_Tsz=1879','_select.eps']);
savefig(['Case_EMIC_th=0_B0=100nT_Tsz=1879','_select.fig']);
