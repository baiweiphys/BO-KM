...
save('saveData_BernsteinModes_ion_deg90_BM8.mat','pas','wws');
...
print(gcf,'-depsc',['saveData_BernsteinModes_ion_deg90_BM8_','select.eps']);
savefig(['saveData_BernsteinModes_ion_deg90_BM8_','select.fig']);
