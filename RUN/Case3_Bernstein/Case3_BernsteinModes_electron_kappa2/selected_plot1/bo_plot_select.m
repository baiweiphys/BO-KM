...
save('saveData1_BernsteinModes_deg90_BK2.mat','pas','wws');
...
print(gcf,'-depsc',['saveData1_BernsteinModes_deg90_BK2_','select.eps']);
savefig(['saveData1_BernsteinModes_deg90_BK2_','select.fig']);
