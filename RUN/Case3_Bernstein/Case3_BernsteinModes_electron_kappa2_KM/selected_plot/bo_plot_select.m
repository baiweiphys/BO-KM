...
save('saveData_BernsteinModes_deg90_KM2.mat','pas','wws');
...
print(gcf,'-depsc',['saveData_BernsteinModes_deg90_KM2_','select.eps']);
savefig(['saveData_BernsteinModes_deg90_KM2_','select.fig']);
