...
save('saveData1_BernsteinModes_deg90_KM2.mat','pas','wws');
...
print(gcf,'-depsc',['saveData1_BernsteinModes_deg90_KM2_','select.eps']);
savefig(['saveData1_BernsteinModes_deg90_KM2_','select.fig']);
