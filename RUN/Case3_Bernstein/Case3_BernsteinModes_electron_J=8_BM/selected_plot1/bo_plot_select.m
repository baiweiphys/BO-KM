...
save('saveData1_BernsteinModes_deg90_BM8.mat','pas','wws');
...
print(gcf,'-depsc',['saveData1_BernsteinModes_deg90_BM8_','select.eps']);
savefig(['saveData1_BernsteinModes_deg90_BM8_','select.fig']);
