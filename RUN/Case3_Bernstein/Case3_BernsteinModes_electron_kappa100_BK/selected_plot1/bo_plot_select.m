...
save('saveData1_BernsteinModes_deg90_BK100.mat','pas','wws');
...
print(gcf,'-depsc',['saveData1_BernsteinModes_deg90_BK100_','select.eps']);
savefig(['saveData1_BernsteinModes_deg90_BK100_','select.fig']);
